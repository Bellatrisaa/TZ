...
TEST_CASE("Method deletepuncmark: delete all puncmarks in string", "File: method_deletepuncmark_test.cpp")
{
...
TEST_CASE("Method deletepuncmark: delete all special chars in string", "File: method_deletepuncmark_test.cpp")
{
...
TEST_CASE("Method deletepuncmark: delete all digits in string", "File: method_deletepuncmark_test.cpp")
{
...
TEST_CASE("Method deletepuncmark: delete all english letters in string", "File: method_deletepuncmark_test.cpp")
{
