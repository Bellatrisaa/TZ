...
TEST_CASE("Method push: add 10 elements to list", "File: method_push_test.cpp")
{
    ...
    test_list.push(5, (unsigned char*)"�����", 0, 5);
    test_list.push(7, (unsigned char*)"�������", 0, 7);
    test_list.push(12, (unsigned char*)"�������������", 0, 12);
    test_list.push(2, (unsigned char*)"��", 0, 2);
    test_list.push(5, (unsigned char*)"�����", 0, 5);
    test_list.push(5, (unsigned char*)"�����", 0, 5);
    test_list.push(1, (unsigned char*)"�", 0, 1);
    test_list.push(4, (unsigned char*)"����", 0, 4);
    test_list.push(14, (unsigned char*)"��������������", 0, 14);
    test_list.push(5, (unsigned char*)"�����", 0, 5);
    test_list.listtofile(
