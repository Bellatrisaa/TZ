...
TEST_CASE("Method sort_alphabet: sort of two words", "File: method_sort_alphabet.cpp")
{
	...
	test_list.listtofile("test/singleList_methods_test/test_txt_files/test_3.1.txt");
